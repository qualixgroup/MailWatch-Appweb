          ...
          {activeTab === 'Integrações' && (
            <section className="bg-white dark:bg-surface-dark border border-gray-200 dark:border-border-dark rounded-2xl p-6 animate-fade-in transition-colors">
              ...
              <div className="space-y-4">
                ...
                <div className={`flex items-center justify-between p-4 bg-gray-50 dark:bg-background-dark border rounded-xl transition-all ${whatsappConnected ? 'border-emerald-500/30' : 'border-gray-200 dark:border-border-dark'}`}>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className={`text-xs font-bold ${whatsappConnected ? 'text-emerald-500' : 'text-gray-500 dark:text-text-dim'}`}>
                        {whatsappConnected ? t('active_sync') : t('disconnected')}
                      </p>
                    </div>
                  </div>
                  <button
                    ...
                    className={`px-4 py-2 text-xs font-bold rounded-lg transition-all border border-transparent ${whatsappConnected ? 'text-red-500 hover:bg-red-500/10 hover:border-red-500/20' : 'text-primary hover:bg-primary/10 hover:border-primary/20'}`}
                  >
                    {whatsappConnected ? t('disconnect') : t('connect')}
                  </button>
                </div>
              </div>
            </section>

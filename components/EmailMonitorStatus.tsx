...
const EmailMonitorStatus: React.FC = () => {
    ...
    return (
        <div className="bg-white dark:bg-surface-dark border border-gray-200 dark:border-border-dark rounded-2xl p-4">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="font-bold text-gray-900 dark:text-white text-sm">Monitoramento Automático</h3>
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className="p-2 text-gray-500 dark:text-text-dim hover:text-primary hover:bg-primary/10 rounded-lg transition-all disabled:opacity-50"
            ...
            {/* Details Panel */}
            {showDetails && (
                <div className="mt-4 pt-4 border-t border-gray-200 dark:border-border-dark space-y-3">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                            <p className="text-gray-500 dark:text-text-dim">Emails processados</p>
                            <p className="text-gray-900 dark:text-white font-bold">{state.processedCount}</p>
                        </div>
                        <div>
                            <p className="text-gray-500 dark:text-text-dim">Intervalo</p>
                            <p className="text-gray-900 dark:text-white font-bold">{settings.checkInterval / 1000} segundos</p>
                        </div>
                    </div>
